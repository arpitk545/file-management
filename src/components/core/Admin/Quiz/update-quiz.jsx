...
import { BookOpen, X, Plus, Target, Sparkles, Trash2, Save, Database, Clock, User, Tag, Upload, FileInput, FileUp, Bot } from "lucide-react"
import { getQuizById, updateQuizById, getAllQuizRegions, getAllQuizQuestions, extractQuestionsFromFile } from "../../../../services/operations/quizAPI"
...
export default function UpdateQuiz() {
  ...
  // Fetch regions and quiz data on component mount
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const regionObj = regionsResponse.data.find(r => r.name === quizData.category?.region)
  ...
  // Fetch questions from quiz bank
