...
const MenuBar = ({ editor }) => {
  ...
  const setHeading = (level) => {
    // Toggle the heading - if already active, remove it
...
const ArticlesEditor = ({ content, onChange, placeholder = "Write your article content here..." }) => {
  ...
  return (
    <div className="w-full bg-white rounded-2xl focus-within:ring-4 focus-within:ring-blue-100 focus-within:border-blue-500 transition-all duration-200">
      <div className="p-4">
