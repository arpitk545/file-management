          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-800 text-base sm:text-lg leading-relaxed ml-8">{contestDetails.description}</p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-medium ml-8">{new Date(contestDetails.startTime).toLocaleDateString("en-US", {
                      year: "numeric",
                      month: "long",
                      day: "numeric",
                    })}</p>
