...
import { Edit, Trash2, Filter, ArrowLeft, Plus, List, CheckCircle, Ban, Upload, FileEdit,  X } from "lucide-react";
...
export default function ViewsubmittedQandA() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filter Q&As to only show those with "user" role
        const userQandas = allQandas.filter(qanda => 
          qanda.roles && qanda.roles.includes("user")
        );
        
        setQandas(userQandas);
        setFilteredQandas(userQandas);
      } catch (error) {
        ...
        >
          ...
          <div className="bg-gradient-to-r from-violet-600 to-purple-700 px-6 py-8 sm:px-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">User Q&A Management</h1>
                <p className="text-indigo-100 text-sm sm:text-base">View and manage Q&As with user role</p>
              </div>
              <motion.button
          ...
          <div className="p-6 sm:p-8 bg-gradient-to-r from-emerald-50 to-teal-50">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-800">
                User Q&A List ({filteredQandas.length})
            ...
            {isLoading ? (
              ...
              <>
                {/* Desktop Table - REMOVED Chapter column from display */}
                      ...
                      <AnimatePresence>
                        {filteredQandas.map((qanda, index) => (
                          ...
                          >
                            ...
                            {/* REMOVED: Chapter column from table body */}
                ...
                {/* Mobile Cards - REMOVED Chapter from display */}
                      ...
                      >
                        <div className="flex flex-col gap-3">
                          ...
                          <div className="grid grid-cols-2 gap-3 text-sm">
                            {/* REMOVED: Chapter from mobile view */}
            ...
            {!isLoading && filteredQandas.length === 0 && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">No User Q&As found</h3>
                <p className="text-gray-600">
                  {qandas.length === 0
                    ? "No Q&As with user role found."
