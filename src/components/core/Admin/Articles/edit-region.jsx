...
const EditRegion = () => {
  ...
  const deleteSubcategory = (categoryId, subcategoryId, e) => {
    ...
    setSelectedRegion(prev => ({
      ...
      category: prev.category.map(cat => 
        cat._id === categoryId 
          ? { ...cat, subCategory: cat.subCategory.filter(sub => sub._id !== subcategoryId) }
          : cat
      )
    }))
    if (selectedCategory?._id === categoryId) {
  ...
  return (
    <div className="fixed inset-0 overflow-auto bg-gradient-to-br from-teal-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Main Card - Adjusted padding and margins */}
        <div className="bg-white dark:bg-gray-800 rounded-xl md:rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
          ...
          {/* Card Content - Adjusted padding and spacing */}
          <div className="p-4 md:p-6">
            <div className="space-y-4 md:space-y-6">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {selectedRegion?._id === region._id ? (
                          <input
                            ...
                            className="flex-1 text-sm md:text-base font-medium text-gray-800 dark:text-white bg-transparent border-b border-transparent focus:border-teal-300 focus:outline-none px-1"
                            onClick={(e) => e.stopPropagation()}
                          />
                        ) : (
                          <span className="text-sm md:text-base font-medium text-gray-800 dark:text-white">{region.name}</span>
                        )}
              ...
              {/* Categories Section - Adjusted indentation for mobile */}
              {selectedRegion && (
                <div className="ml-2 sm:ml-4 md:ml-6 border-l-2 border-gradient-to-b from-teal-300 to-blue-300 pl-2 sm:pl-4 md:pl-6 space-y-3 md:space-y-4">
                  ...
                  {/* Subcategories Section - Adjusted indentation for mobile */}
                  {selectedCategory && (
