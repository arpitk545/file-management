                ...
                <div className="flex-grow space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-y-3 text-sm">
                    ...
                    <div className="flex items-center gap-2 text-gray-700">
                      ...
                      <span className="font-semibold">Questions:</span> {contest.questions?.length || 0}
                    </div>
                    <div className="flex items-center gap-2 text-gray-700 col-span-2">
                      <Calendar className="w-4 h-4 text-purple-600" />
                      <span className="font-semibold">Deadline:</span> {formatDateTime(contest.deadline)}
                    </div>
                    <div className="flex items-center gap-2 text-gray-700 col-span-2">
                      <Timer className="w-4 h-4 text-green-600" />
                      <span className="font-semibold">Start Time:</span> {formatDateTime(contest.startTime)}
                    </div>
                  </div>
                    ...
                    {openDetails[contest._id] && (
                      ...
                      >
                        <div className="flex items-center gap-2 text-gray-700">
                          ...
                          <span className="font-semibold">Region:</span> {contest.regionName || contest.region}
                        </div>
                        <div className="flex items-center gap-2 text-gray-700">
                          <FileText className="w-4 h-4 text-indigo-600" />
                          <span className="font-semibold">Exam Type:</span> {contest.examType}
                        </div>
                        <div className="flex items-center gap-2 text-gray-700">
                          <Users className="w-4 h-4 text-indigo-600" />
                          <span className="font-semibold">Class:</span> {contest.specificClass}
                        </div>
                        <div className="flex items-center gap-2 text-gray-700">
                          <BookOpen className="w-4 h-4 text-indigo-600" />
                          <span className="font-semibold">Subject:</span> {contest.subject}
                        </div>
                        <div className="flex items-center gap-2 text-gray-700">
                          <Target className="w-4 h-4 text-indigo-600" />
                          <span className="font-semibold">Chapter:</span> {contest.chapter}
                        </div>
                      </motion.div>
                    )}
                  </AnimatePresence>
